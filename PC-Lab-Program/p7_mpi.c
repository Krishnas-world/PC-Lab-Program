//Lab 7: Write a MPI Program to demonstration of Broadcast operation.
...
2
Process 0 broadcasting data = 2
Process 0 received data = 2
Process 1 received data = 2
Process 2 received data = 2
Process 3 received data = 2  */